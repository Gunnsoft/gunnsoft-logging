...
Task("Publish")
    ...
    .Does(() => 
    {
        var exitCode = StartProcess("dotnet", new ProcessSettings
        {
            Arguments = $@"pack src\Gunnsoft.Logging --configuration {configuration} --no-restore /p:Version={version}"
        });
...
Task("Copy")
    ...
    .Does(() =>
    {
        ...
        CopyFile($@".\src\Gunnsoft.Logging\bin\{configuration}\Gunnsoft.Logging.{version}.nupkg", $@"{artifactsDirectory}\gunnsoft-logging.nupkg"); 
